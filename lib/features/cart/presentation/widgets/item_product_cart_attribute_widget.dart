...
class ItemProductCartAttributeWidget extends StatefulWidget {
  final CartAttributeEntity? item;

  const ItemProductCartAttributeWidget({this.item});

  @override
  _ItemProductCartAttributeWidgetState createState() => _ItemProductCartAttributeWidgetState();
}

class _ItemProductCartAttributeWidgetState extends State<ItemProductCartAttributeWidget> {
  @override
  void initState() {
                ...
                children: [
                  Expanded(
                    ...
                    child: InkWell(
                      onTap: () {
                        cartProvider
                            .decreaseItemCount(widget.item!.id);
                      },
                      child: Container(
                          decoration: BoxDecoration(
                              color: globalColor.white,
                  ...
                  Expanded(
                    ...
                    child: InkWell(
                      onTap: () {
                        cartProvider
                            .increaseItemCount(widget.item!.id);
                      },
                      child: Container(
                          decoration: BoxDecoration(
                              color: globalColor.white,
