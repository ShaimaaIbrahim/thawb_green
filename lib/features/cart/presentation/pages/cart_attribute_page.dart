...
import 'package:ojos_app/features/cart/presentation/widgets/item_product_cart_attribute_widget.dart';
...
class CartAttributePage extends StatefulWidget {
  static const routeName = '/cart/pages/CartAttributePage';
  final TabController? tabController;

  const CartAttributePage({this.tabController});

  @override
  _CartAttributePageState createState() => _CartAttributePageState();
}

class _CartAttributePageState extends State<CartAttributePage> {
  //var parameters = Get.Get.parameters;

  // var  args = Get.Get.arguments as CartPageTafsilArgs;
                ...
                return ModalProgressHUD(
                  ...
                  child: Container(
                    child: Consumer<CartProvider>(
                      ...
                      if (cartProvider.getAttributeItems() != null &&
                          cartProvider.getAttributeItems()!.isNotEmpty)
                                            ...
                                            Container(
                                              child: ListView.builder(
                                                ...
                                                itemBuilder: (context, index) {
                                                  return ItemProductCartAttributeWidget(
                                                    item: cartProvider
                                                            .getAttributeItems()![
                                                        index],
                                                  );
  ...
  _buildPricesWidget(
    ...
    if (_isCouponApply == true && _couponInfoSuccess.type == 1) {
      discount = cartProvider.getTotalPricesAttributeAfterDiscount() -
      ...
      child: Column(
        children: [
          _buildPricesInfoItem(
              height: height,
              width: width,
              value: cartProvider.getTotalAttriburtePricesint().toString(),
              title:
              ...
              child: InkWell(
                onTap: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    int priceDiscount =
                        (cartProvider.getTotalPricesAttributeAfterDiscount() -
                                cartProvider.getTotalAttriburtePricesint())
                            .abs();
                    ...
                    cartApi
                        .completeOrderOnline(
                            cartProvider.listAttributeOfCart[0],
                            phone: _phone,
                            method_id: _paymentMethods.id,
                            delivery_fee: settings.fee_delivery!,
                            tax: settings.default_tax)
                        .then((value) {
                      if (value == true) {
                        appConfig.showToast(
                          msg: Translations.of(context)
                              .translate('ordered_successfully'),
                        );
