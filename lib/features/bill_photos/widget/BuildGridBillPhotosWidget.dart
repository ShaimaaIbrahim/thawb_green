...
class BuildGridBillPhotosWidget extends StatefulWidget {
  ...
  const BuildGridBillPhotosWidget({
  ...
  State<StatefulWidget> createState() {
    return _BuildGridBillPhotosWidgetState();
  }
}

class _BuildGridBillPhotosWidgetState extends State<BuildGridBillPhotosWidget>
    with AutomaticKeepAliveClientMixin<BuildGridBillPhotosWidget> {
  @override
    ...
    return Container(
      ...
      child: NetworkGrid<ProductFavoriteEntity>(
        ...
        placeHolder: (context) {
          return Center(
            child: Text(
              Translations.of(context).translate('no_images'),
