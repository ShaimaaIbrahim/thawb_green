...
class AddToCartDialog extends StatefulWidget {
  final CartPageGahezArgs? arguments;
  final Map<String, String>? parameters;

  AddToCartDialog({Key? key, this.arguments, this.parameters})
      : super(key: key);
