...
const ADDS_KEY = 'ADDS_KEY';

// ====================  APP_NAME API URL ====================
const API_BASE = 'https://www.greenthoob.com/api/auth';
//==========================
//   User Management API
//==========================
...
const API_INVOICE= "https://greenthoob.com/api/auth/invoices";
const API_WALLET= "https://greenthoob.com/api/auth/client-wallet";
...
const orders_attributes = '$API_PRODUCT/attributes';
const orders_post_orderOnlines = '$API_PRODUCT/orderOnlines';

/// product_with Category

String productUrl(int categoryId) {
  return '$API_BASE/home-app/?category_id=$categoryId';
}

const String walletUrl='$API_BASE/client-wallet';

String categoryUrl = '$API_BASE/categories';
...
const API_GET_ORDER_ONLINE = '$API_ORDER/orderOnlines';
const API_SEND_ORDER_ONLINE = '$API_ORDER/orderOnlines';

String getOrderDetails(orderId) {
  return '$API_ORDER/orders/$orderId';
}

String getOrderDetailsOnline(orderId) {
  return '$API_ORDER/orderOnlines/$orderId';
}
...
///product- Category
///
const API_PRODUCT_CATEGORY = '$API_SETTINGS/contact_us';
