...
import 'package:ojos_app/features/bill_photos/bill_photos.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: CartAttributePage.routeName,
      page: () => CartAttributePage(),
    ),
    ...
    GetPage(
      name: ImageViewrPage.routeName,
      page: () => ImageViewrPage(),
    ),

    GetPage(
      name: VideoPlayerVideo.routeName,
      page: () => VideoPlayerVideo(),
    ),
    GetPage(
      name: PillPhotosPage.routeName,
      page: () => PillPhotosPage(),
    ),
    /// main pages
    GetPage(
